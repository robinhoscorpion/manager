...
const systemVariables = [
    ...
    { value: 'data_atual', label: 'Data' },
    { value: 'assoc1_nome_completo', label: 'Nome do Associado #1' },
    { value: 'assoc1_sobrenome', label: 'Sobrenome (Associado #1)' },
    { value: 'assoc1_nomes', label: 'Nome(s) (Associado #1)' },
    { value: 'assoc1_rg_cpf', label: 'RG / CPF (Associado #1)' },
    { value: 'assoc2_nome_completo', label: 'Nome do Co-Associado #2' },
    { value: 'assoc2_sobrenome', label: 'Sobrenome (Associado #2)' },
    { value: 'assoc2_nomes', label: 'Nome(s) (Associado #2)' },
    { value: 'assoc2_rg_cpf', label: 'RG / CPF (Associado #2)' },
    { value: 'assoc1_data_nascimento', label: 'Data de Nascimento #1' },
    { value: 'assoc2_data_nascimento', label: 'Data de Nascimento #2' },
    { value: 'assoc1_nacionalidade', label: 'Nacionalidade #1' },
    { value: 'assoc2_nacionalidade', label: 'Nacionalidade #2' },
    { value: 'endereco_residencial', label: 'Endereço Residencial' },
    { value: 'endereco_pais', label: 'País' },
    { value: 'endereco_cidade', label: 'Cidade' },
    { value: 'endereco_estado', label: 'Estado' },
    { value: 'endereco_bairro', label: 'Bairro' },
    { value: 'endereco_cep', label: 'CEP' },
    { value: 'telefone_1', label: 'Telefone 1' },
    { value: 'telefone_2', label: 'Telefone 2' },
    { value: 'telefone_3', label: 'Telefone 3' },
    { value: 'email_1', label: 'Correio Eletrônico #1' },
    { value: 'email_2', label: 'Correio Eletrônico #2' },
];
