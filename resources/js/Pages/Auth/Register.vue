        ...
        <div class="login-container">
            <div class="login-card">
                <div class="login-header">
                    ...
                    <p class="login-subtitle">Comece sua jornada agora.</p>
                </div>
                ...
                <form @submit.prevent="submit">
                    ...
                    >
                        {{ form.processing ? 'Criando...' : 'Cadastrar na Plataforma' }}
                    </button>
                </form>

                <div class="login-footer">
                    Já possui uma conta? 
                    <Link :href="route('login')" class="login-link">Fazer login</Link>
                </div>
            </div>
        </div>
    </div>
